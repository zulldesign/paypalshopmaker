...
(function(P) {
	...
	P.displayRecs = 6; // Number of records per page
	P.recPerRow = 0; // Number of records per row (multi column)
	...
	P.CATEGORY_DEFAULT_ORDERBY = "CategoryLevel, CategoryDisplayOrder, CategoryParentId"; // 6.0
	...
	P.PRODUCT_COUNT_CLASS_NAME = "badge";
	...
	P.MENUBAR_CLASSNAME = "navbar-nav"; 	
	P.MENU_CLASSNAME = "navbar-nav"; 		
	P.MENU_ITEM_CLASSNAME = "dropdown";			
	P.MENUBAR_ITEM_LABEL_CLASSNAME = "navbar-nav";	 
	P.MENULINK_DROPDOWN_IMAGE = "<span class=\"icon-arrow-right\"></span>";
	P.SUBMENU_ITEM_CLASSNAME = "dropdown-submenu"; 
	P.SUBMENU_CLASSNAME = "dropdown-menu";	
	P.SUBMENU_DROPDOWN_IMAGE = "<span class=\"icon-arrow-down\"></span>";
	P.CART_LIST_PAGE = "cartlist.php";
	P.CART_VIEW_PAGE = "cartview.php";
	P.CHECKOUT_PAGE = "checkout.php";
	P.SHIP_PAGE = "shipping.php";
	P.CONFIRM_PAGE = "confirm.php";
	P.FINISH_PAGE = "finish.php";
	P.MENU_PAGE = "menupage.php";
	P.TEMPLATE_PAGE = "";
	P.QUERY_PAGE = "ewquery.php";
	P.IMAGE_THUMBNAIL_WIDTH = 200;
	P.IMAGE_THUMBNAIL_WIDTH_MOBILE = ; 
	P.IMAGE_THUMBNAIL_WIDTH_VIEW = 250;
	P.IMAGE_THUMBNAIL_HEIGHT = 0;
	P.IMAGE_THUMBNAIL_HEIGHT_MOBILE = ;
	...
	P.IMAGE_PATH = "images";
	P.ITEM_ID = "id";
	P.INCLUDE_SUBCATEGORY = true;
	P.BODY_TITLE = "PayPal Shop Maker 6 Demo Project";
	P.MENU_ID = "menu";	
	P.START_REC = "start";
	P.PAGE_NO = "page";
	...
	P.SHOW_CATEGORY_PRODUCT_COUNT = false;
	P.SHOW_EMPTY_CATEGORY = true;
	P.MENU_ITEM_LABEL_CLASSNAME = "dropdown-submenu";	
	P.MENU_ROOT_GROUP_TITLE_AS_SUBMENU = true; 
	P.ALPHA_ID = "alpha";
